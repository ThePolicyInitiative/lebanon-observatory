  ...
  return (
    <div>
      ...
      <div className="grid gap-4 lg:grid-cols-[3fr_2fr]">
        <div>
          {/* Width is capped so the 620x860 map never grows taller than
              ~76vh; the SVG itself always fills that width. */}
        ...
        >
          {selectedZone && zoneMentions ? (
            ...
            <>
              ...
              <p className="mt-1 text-xs text-[color:var(--color-text-secondary)]">
                {selectedRecords.length} traced traced activities under the
