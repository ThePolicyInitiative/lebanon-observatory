...
const T = {
  en: {
    ...
    sub: "Filled teal circles: milestones reached. Amber diamonds: processes under way. Open rust circles: not confirmed or unpaid at the latest review. Grey squares: conflict context.",
    caveat:
      "Procurement under way is a process milestone, not data of completed reconstruction. Completed works were not publicly confirmed at the latest review.",
    description:
      "Timeline scatter across five tracks (conflict, data, state decisions, finance, procurement) from December 2024 to July 2026, showing the 2025 approval cluster, the 2026 procurement publications, first disbursement in May 2026, and the absence of confirmed completed output at the latest review.",
  ...
  ar: {
    ...
    sub: "دوائر فيروزية ممتلئة: محطات بلغت. معينات كهرمانية: مسارات جارية. دوائر خمرية مفرغة: غير مؤكَّدة أو غير مدفوعة عند آخر مراجعة. مربعات رمادية: سياق الحرب.",
    caveat:
      "الشراء الجاري محطة إجرائية، لا معطى عن إعادة إعمار مكتملة. ولم تُعلَن أي أشغال مكتملة ومؤكَّدة عند آخر مراجعة.",
    description:
      "رسم نقطي زمني على خمسة مسارات (الحرب، المعطيات، قرارات الدولة، التمويل، الشراء) من كانون الأول 2024 إلى تموز 2026، يُظهر تجمّع الإقرارات في 2025، وإعلانات الشراء في 2026، وأول دفعة في أيار 2026، وغياب إنجاز مكتمل مؤكَّد عند آخر مراجعة.",
    ...
    chain: [
      ...
      ["الإنجاز المؤكَّد", "لا إنجاز مكتمل مؤكَّد عند آخر مراجعة"],
    ],
  },
} as const;
