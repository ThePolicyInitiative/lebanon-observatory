      ...
      <div className="mt-10 space-y-16">
        ...
        <section aria-labelledby="finding-needs">
          ...
          <p className="mt-5 max-w-3xl text-body leading-loose text-text-secondary">
            من احتياجات تناهز 11 مليار دولار، توقّع التقييم أن يعبّئ القطاع
            العام نحو 3 إلى 5 مليارات دولار وأن يعبّئ القطاع الخاص 6 إلى 8
            مليارات إضافية. التقديرات التي يقوم عليها هذان الرقمان تأتي
            تباعاً، معروضةً كل منها بمنهجيتها ونطاقها ووحدتها وقابليتها
            للمقارنة - ولا تُجمع ولا يؤخذ متوسطها ولا تُدمج أبداً. لا يوجد عدّ واحد لأبنية حرب 2024،
