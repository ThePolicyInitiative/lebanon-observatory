    ...
    >
      ...
      <div className="mt-8">
        <Takeaways
          ...
          matters="نظام أكثر تماسكاً على الورق وبلا تغيّر في قاعه هو نظام غير مستقر: الأبعاد الكهرمانية - التمويل والشراء والرقابة - هي ما تستطيع دورة الإبلاغ المقبلة حسمه، نحو الإنجاز أو نحو الإجراء، والتتبّع صار موجوداً ليُخضِع كل تحوّل منها لتاريخ."
        />
      </div>
    </ArabicPageShell>
  );
