...
const T = {
  ...
  ar: {
    ...
    sub: "منذ 2 آذار 2026 كان في لبنان ثلاثة مسارات منفصلة مؤسسياً. ومعظم الالتباس العام حول «إعادة إعمار لبنان» في منتصف 2026 مصدره قراءة نشاط المسار الثاني الظاهر (وجبات، مراكز إيواء، فتح طرق) أو محطات المسار الأول الإجرائية (مناقصات، دفعات) وكأنها تخصّ المسار الثالث - الذي بقي فارغاً.",
