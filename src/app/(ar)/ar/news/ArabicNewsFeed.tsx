  ...
  return (
    <section aria-labelledby="ar-news-feed">
      ...
      <p className="mt-4 note-caution text-[12.5px] leading-relaxed text-[color:var(--color-text-secondary)]">
        كل خبر يبقى بلغة ناشره ويحيل إليه. وكل خبر هنا يسمّي لبنان أو مكاناً
        لبنانياً: تغطية حروب البلدان الأخرى مستبعَدة، ولو نشرتها وسيلة لبنانية.
        هذه المستجدات غير مؤكَّدة ولا تدخل في أي عدّ من أعداد المرصد. الترشيح
        والبحث الكاملان في الصفحة الإنجليزية.
      </p>
    </section>
  );
}
