    ...
    >
      <div className="mt-10 space-y-16">
        ...
        <section aria-labelledby="finding-needs">
          ...
          <p className="mt-5 max-w-3xl text-body leading-loose text-text-secondary">
            ...
            ولم يكن لحرب 2026 أي تقييم وطني حتى 31 آب 2026؛ وتعدّد التقديرات
      ...
      <div className="mt-16">
        <Takeaways
          ...
          unchanged="التحويل. لا عدّ مرجعي واحد لأبنية أي من الحربين، والبقاع وبعلبك-الهرمل لم يُقيَّما أبداً في 2026، ولم يُدفع من القرض سوى 4.13 مليون دولار - أي 1.65% - حتى 29 حزيران 2026، ولم يُؤكَّد علناً أي إنجاز إعادة إعمار مكتمل حتى 31 آب 2026."
