...
export const metadata: Metadata = {
  title: "البحث",
  description:
    "مدخل واحد إلى مرصد إعادة إعمار لبنان: ابحث عن صفحة أو جهة فاعلة متتبَّعة أو بلدة أو مجموعة جهات أو فئة أفعال أو مرحلة من مراحل الاستجابة أو مؤشّر أو محطة زمنية، بالعربية أو بالإنجليزية.",
...
export default function Page() {
  return (
    <ArabicPageShell
      ...
      lede="حقل واحد على الموقع كله: كل صفحة من صفحات التحليل وأقسامها، وكل جهة فاعلة متتبَّعة في السجل، والبلدات المسمّاة والتجمّعات الإقليمية، ومجموعات الجهات الأربع وفئات الأفعال الأربع، ومراحل الاستجابة الاثنتي عشرة، والمؤشرات والمحطات الزمنية. العربية والإنجليزية تبلغان الوجهة نفسها، فالاستعلام بأيّ منهما يجدها."
      point={
        <>
