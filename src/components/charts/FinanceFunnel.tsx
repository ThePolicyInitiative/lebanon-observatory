...
const T = {
  en: {
    ...
    barsAlt:
      "Nested bars: assessed need US$11 billion (100%); LEAP framework US$1 billion (9.09% of need); initial loan US$250 million (2.27% of need); disbursed US$4.13 million (about 0.04% of need). Works contracts awarded and confirmed completed output: zero at the latest review.",
    magnifiedAlt:
  ...
  ar: {
    ...
    barsAlt:
      "أشرطة متداخلة: الاحتياج المقدَّر 11 مليار دولار (100%)؛ إطار LEAP مليار دولار (9.09% من الاحتياج)؛ القرض الأولي 250 مليون دولار (2.27%)؛ المدفوع 4.13 مليون دولار (نحو 0.04%). وعقود الأشغال المُرساة والإنجاز المكتمل المؤكَّد: صفر عند آخر مراجعة.",
    magnifiedAlt:
