...
function buildYear(year: Year): Row[] {
...
const MATRICES: { year: Year; rows: Row[] }[] = [
                  ...
                  <tr key={r.base} className="border-t border-[#EDF0F4] hover:bg-[#F8FAFC]">
                    ...
                    {r.cells.map((c, i) => (
                      <td key={i} className="px-1 py-1 text-center">
                        {c > 0 ? (
                          <span
                            className="inline-flex h-5 w-9 items-center justify-center rounded-[3px] text-[10.5px] font-bold tabular-nums"
                            style={{
                          ...
                          <span aria-hidden className="inline-block h-5 w-9 rounded-[3px] bg-[#F1F3F6]" />
                        )}
                      </td>
                    ))}
