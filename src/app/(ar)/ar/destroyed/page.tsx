  ...
  return (
    <ArabicPageShell
      ...
      figures={[
        ...
        { value: "11,095", label: "مبنى مدمَّراً كلياً جنوب الليطاني في تقييم 2026" },
    ...
    >
      ...
      <section aria-labelledby="ar-tracks" className="mt-7">
        <h2 id="ar-tracks" className="text-h2 font-semibold text-navy">
        ...
        <div className="mt-4 card">
          <h3 className="text-body font-semibold text-navy">ركام 2024</h3>
      ...
      <section aria-labelledby="ar-zones" className="mt-7">
        <h2 id="ar-zones" className="text-h2 font-semibold text-navy">
