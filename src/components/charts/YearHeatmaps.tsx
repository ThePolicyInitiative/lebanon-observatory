...
const T = {
  en: {
    ...
    sub: "Each panel shows traced actors per layer and stage for one year, on one shared scale (darker = more traced actors). Coordination is left out: nearly every actor touches it, so the column says more about who convenes than about where work sits along the chain. Hover a cell for its value; the counts behind the whole figure are in its description.",
  ...
  ar: {
    ...
    sub: "كل لوحة تُظهر الجهات المرصودة بحسب الطبقة والمرحلة في سنة واحدة، على مقياس واحد مشترك (كلما دكن اللون زاد عدد الجهات المرصودة). ومرحلة التنسيق خارج الشكل: تكاد كل جهة تمسّها، فعمودها يقول عمّن ينسّق أكثر ممّا يقول أين يقع العمل على السلسلة. مرِّر فوق خانة لترى قيمتها؛ والأعداد خلف الشكل كله واردة في وصفه.",
