...
const T = {
  en: {
    ...
    asOf: "as of",
    caution:
      "“Returns” measure movement, not durable return: people counted as returned may have gone back to a damaged building, to relatives, or to a rental while awaiting repairs or compensation that, at the latest review, no financed instrument had delivered.",
  },
  ar: {
    ...
    asOf: "حتى",
    caution:
      "«العودات» تقيس الحركة لا العودة الدائمة: من يُحصى عائداً قد يكون رجع إلى بناء متضرّر، أو إلى أقارب، أو إلى مسكن مستأجَر في انتظار ترميم أو تعويض لم تكن أي أداة تمويل قد أوصلته عند آخر مراجعة.",
  },
} as const;
